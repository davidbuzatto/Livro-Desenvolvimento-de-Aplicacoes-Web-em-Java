...
function prepararMenu() {
    ...
    document.getElementById( "itemMenuHome" ).addEventListener(
        "click", 
        event => {
    ...
    document.getElementById( "itemMenuVendas" ).addEventListener(
        "click", 
        event => {
    ...
    document.getElementById( "itemMenuClientes" ).addEventListener( 
        "click",
        event => {
    ...
    document.getElementById( "itemMenuFornecedores" ).addEventListener(
        "click",
        event => {
    ...
    document.getElementById( "itemMenuProdutos" ).addEventListener(
        "click",
        event => {
    ...
    document.getElementById( "itemMenuCidades" ).addEventListener( 
        "click",
        event => {
    ...
    document.getElementById( "itemMenuEstados" ).addEventListener(
        "click",
        event => {
    ...
    document.getElementById( "itemMenuUnidadesMedida" ).addEventListener(
        "click",
        event => {
