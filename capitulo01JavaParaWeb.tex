...
Para isso, baixe o arquivo acessível através do \textit{link} \url{https://dlm.mariadb.com/2338690/Connectors/java/connector-java-3.0.6/mariadb-java-client-3.0.6.jar} e, ao terminar de baixar, copie-o para o diretório \texttt{C:\textbackslash Users\textbackslash SeuUsuario\textbackslash glassfish5\textbackslash glassfish\textbackslash\\domains\textbackslash domain1\textbackslash lib\textbackslash}.
