...
console.log(cumprimentar("Ana", "Oi"));     // "Oi, Ana!"
...
No capítulo~\ref{cap:webservicesRestful}, a função \inlineJavaScriptCode{customFetch} usa esse recurso em sua assinatura --- \inlineJavaScriptCode{customFetch(url, metodo, dados = null, propToken = "token")} ---, tornando os dois últimos argumentos opcionais.
